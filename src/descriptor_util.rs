...
use anyhow::Result;
use vulkanalia::vk::{DescriptorSet, DeviceMemory, DeviceV1_0, HasBuilder};
...
pub unsafe fn create_descriptor_pool(device: &Device, data: &mut AppData, max_objects: u32) -> Result<()> {
...
pub unsafe fn create_descriptor_sets(device: &Device, data: &mut AppData, object: &mut RenderObject) -> Result<()> {
    // Allocate
